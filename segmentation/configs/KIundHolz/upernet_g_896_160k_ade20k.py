...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/KIundHolz_full.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=num_classes, in_channels=[512, 1024, 2048, 4096]),
    auxiliary_head=dict(num_classes=num_classes, in_channels=2048),
